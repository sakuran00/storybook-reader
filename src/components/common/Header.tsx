...
export default function Header({ title, navItems = [] }: HeaderProps) {
  ...
  return (
    <header className={`mx-auto pl-4 sticky top-0 z-30 border-b border-gray-200 ${zenMaru.className}`}>
      ...
      <>
          <div className="flex items-center gap-3">
            <span className="font-bold tracking-[0.36em] text-sm text-shadow-2xs">{title}</span>
          </div>
